...
const ActivityPage = ({
  ...
  const activityPortfolios = portfolios.filter(
    (portfolio) => portfolio.type === "activity",
  );
  activityPortfolios.reverse();
  ...
  return (
    <>
      ...
      <div className="flex justify-between md:flex-row flex-col md:gap-0 gap-5 mb-10">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-purple-200 text-lg sm:text-xl md:text-2xl">
            ทั้งหมด {activityPortfolios.length} รายการ
          </p>
        </div>
      ...
      {/* Portfolio Grid */}
      {activityPortfolios.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {activityPortfolios.map((portfolio, index) => {
                ...
                <div className="p-6 flex flex-col h-full">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div
                      ...
                      className="text-white hover:scale-108 hover:rotate-12 cursor-pointer bg-red-600 hover:bg-red-700 transition-all duration-300 ease-in-out items-center justify-center flex w-8 h-8 rounded-lg"
                    >
